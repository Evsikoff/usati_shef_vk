...
(function(t) {
    class s extends t.RuntimeObject {
        ...
        setEmitterAngle(e) {
            const i = this.getEmitterAngle();
            e !== i && (this._angleDirty = !0, this.angleA += e - i, this.angleB += e - i)
        }
        getEmitterAngleA() {
            return this.angleA
        }
        setEmitterAngleA(e) {
            this.angleA !== e && (this._angleDirty = !0, this.angleA = e)
        }
        getEmitterAngleB() {
            return this.angleB
        }
        setEmitterAngleB(e) {
            this.angleB !== e && (this._angleDirty = !0, this.angleB = e)
        }
        getConeSprayAngle() {
            return this.getEmitterAngleB()
        }
        setConeSprayAngle(e) {
            this.setEmitterAngleB(e)
        }
        getZoneRadius() {
            return this.zoneRadius
        }
        setZoneRadius(e) {
            e < 0 && (e = 0), this.zoneRadius !== e && e > 0 && (this._zoneRadiusDirty = !0, this.zoneRadius = e)
        }
        getParticleLifeTimeMin() {
            return this.lifeTimeMin
        }
        setParticleLifeTimeMin(e) {
            e < 0 && (e = 0), this.lifeTimeMin !== e && (this._lifeTimeDirty = !0, this.lifeTimeMin = e)
        }
        getParticleLifeTimeMax() {
            return this.lifeTimeMax
        }
        setParticleLifeTimeMax(e) {
            e < 0 && (e = 0), this.lifeTimeMax !== e && (this._lifeTimeDirty = !0, this.lifeTimeMax = e)
        }
        getParticleGravityX() {
            return this.gravityX
        }
        setParticleGravityX(e) {
            this.gravityX !== e && (this._gravityDirty = !0, this.gravityX = e)
        }
        getParticleGravityY() {
            return this.gravityY
        }
        setParticleGravityY(e) {
            this.gravityY !== e && (this._gravityDirty = !0, this.gravityY = e)
        }
        getParticleGravityAngle() {
            return Math.atan2(this.gravityY, this.gravityX) * 180 / Math.PI
        }
        setParticleGravityAngle(e) {
            if (this.getParticleGravityAngle() !== e) {
                this._gravityDirty = !0;
                const r = this.getParticleGravityLength();
                this.gravityX = r * Math.cos(e * Math.PI / 180), this.gravityY = r * Math.sin(e * Math.PI / 180)
            }
        }
        getParticleGravityLength() {
            return Math.sqrt(this.gravityX * this.gravityX + this.gravityY * this.gravityY)
        }
        setParticleGravityLength(e) {
            e < 0 && (e = 0);
            const i = this.getParticleGravityLength();
            i !== e && (this._gravityDirty = !0, this.gravityX *= e / i, this.gravityY *= e / i)
        }
        getParticleRed1() {
            return t.hexNumberToRGBArray(this.color1)[0]
        }
        setParticleRed1(e) {
            e < 0 && (e = 0), e > 255 && (e = 255);
            const i = t.hexNumberToRGBArray(this.color1);
            this.setParticleColor1AsNumber(t.rgbToHexNumber(e, i[1], i[2]))
        }
        getParticleRed2() {
            return t.hexNumberToRGBArray(this.color2)[0]
        }
        setParticleRed2(e) {
            e < 0 && (e = 0), e > 255 && (e = 255);
            const i = t.hexNumberToRGBArray(this.color2);
            this.setParticleColor2AsNumber(t.rgbToHexNumber(e, i[1], i[2]))
        }
        getParticleGreen1() {
            return t.hexNumberToRGBArray(this.color1)[1]
        }
        setParticleGreen1(e) {
            e < 0 && (e = 0), e > 255 && (e = 255);
            const i = t.hexNumberToRGBArray(this.color1);
            this.setParticleColor1AsNumber(t.rgbToHexNumber(i[0], e, i[2]))
        }
        getParticleGreen2() {
            return t.hexNumberToRGBArray(this.color2)[1]
        }
        setParticleGreen2(e) {
            e < 0 && (e = 0), e > 255 && (e = 255);
            const i = t.hexNumberToRGBArray(this.color2);
            this.setParticleColor2AsNumber(t.rgbToHexNumber(i[0], e, i[2]))
        }
        getParticleBlue1() {
            return t.hexNumberToRGBArray(this.color1)[2]
        }
        setParticleBlue1(e) {
            e < 0 && (e = 0), e > 255 && (e = 255);
            const i = t.hexNumberToRGBArray(this.color1);
            this.setParticleColor1AsNumber(t.rgbToHexNumber(i[0], i[1], e))
        }
        getParticleBlue2() {
            return t.hexNumberToRGBArray(this.color2)[2]
        }
        setParticleBlue2(e) {
            e < 0 && (e = 0), e > 255 && (e = 255);
            const i = t.hexNumberToRGBArray(this.color2);
            this.setParticleColor2AsNumber(t.rgbToHexNumber(i[0], i[1], e))
        }
        setParticleColor1AsNumber(e) {
            this.color1 = e, this._colorDirty = !0
        }
        setParticleColor1(e) {
            this.setParticleColor1AsNumber(t.rgbOrHexStringToNumber(e))
        }
        setParticleColor2AsNumber(e) {
            this.color2 = e, this._colorDirty = !0
        }
        setParticleColor2(e) {
            this.setParticleColor2AsNumber(t.rgbOrHexStringToNumber(e))
        }
        getParticleSize1() {
            return this.size1
        }
        setParticleSize1(e) {
            e < 0 && (e = 0), this.size1 !== e && (this._sizeDirty = !0, this.size1 = e)
        }
        getParticleSize2() {
            return this.size2
        }
        setParticleSize2(e) {
            this.size2 !== e && (this._sizeDirty = !0, this.size2 = e)
        }
        getParticleAlpha1() {
            return this.alpha1
        }
        setParticleAlpha1(e) {
            this.alpha1 !== e && (this._alphaDirty = !0, this.alpha1 = e)
        }
        getParticleAlpha2() {
            return this.alpha2
        }
        setParticleAlpha2(e) {
            this.alpha2 !== e && (this._alphaDirty = !0, this.alpha2 = e)
        }
        startEmission() {
            this._isEmissionPaused = !1, this._renderer.start()
        }
        stopEmission() {
            this._isEmissionPaused = !0, this._renderer.stop()
        }
        isEmitting() {
        ...
        setFlow(e) {
            this.flow !== e && (this.flow = e, this._flowDirty = !0)
        }
        getParticleCount() {
        ...
        setTank(e) {
            this.tank = e, this._tankDirty = !0
        }
        getTexture() {
            return this.texture
        }
        setTexture(e, i) {
            this.texture !== e && this._renderer.isTextureNameValid(e, i) && (this.texture = e, this._textureDirty = !0)
        }
        jumpEmitterForwardInTime(e) {
            this._renderer.update(e)
        }
    }
    t.ParticleEmitterObject = s, t.registerObject("ParticleSystem::ParticleEmitter", t.ParticleEmitterObject)
})(gdjs || (gdjs = {}));
