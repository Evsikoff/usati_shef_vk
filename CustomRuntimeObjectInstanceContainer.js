var gdjs;
(function(s) {
    class l extends s.RuntimeInstanceContainer {
        constructor(t, n) {
            super();
            this._isLoaded = !1;
            this._initialInnerArea = null;
            this._parent = t, this._customObject = n, this._runtimeScene = t.getScene(), this._debuggerRenderer = new s.DebuggerRenderer(this)
        }
        addLayer(t) {
            const n = new s.RuntimeCustomObjectLayer(t, this);
        ...
        loadFrom(t, n) {
            this._isLoaded && this.onDestroyFromScene(this._parent), this._setOriginalInnerArea(n);
            for (let r = 0, e = n.objects.length; r < e; ++r) {
                const i = n.objects[r];
                t.childrenContent && !n.name ? this.registerObject({ ...i,
                    ...t.childrenContent[i.name]
                }) : this.registerObject(i)
            }
            if (n.layers.length > 0)
                for (let r = 0, e = n.layers.length; r < e; ++r) this.addLayer(n.layers[r]);
            else this.addLayer({
                name: "",
                visibility: !0,
                cameras: [{
            ...
            this.createObjectsFrom(n.instances, 0, 0, 0, !0), this._setLayerDefaultZOrders(), this._isLoaded = !0
        }
        _setOriginalInnerArea(t) {
            t.instances.length > 0 && (t._initialInnerArea || (t._initialInnerArea = {
                min: [t.areaMinX, t.areaMinY, t.areaMinZ],
                max: [t.areaMaxX, t.areaMaxY, t.areaMaxZ]
            }), this._initialInnerArea = t._initialInnerArea)
        }
        onDestroyFromScene(t) {
            ...
            for (let r = 0, e = n.length; r < e; ++r) {
                const i = n[r];
                i.onDeletedFromScene(), i.onDestroyed()
            }
        ...
        _updateObjectsPreRender() {
            ...
            for (let n = 0, r = t.length; n < r; ++n) {
                const e = t[n],
                    i = e.getRendererObject();
                i && (i.visible = !e.isHidden(), i.visible && this.getGame().getEffectsManager().updatePreRender(e.getRendererEffects(), e)), this._debugDrawEnabled && this._debuggerRenderer.renderDebugDraw(t, this._debugDrawShowHiddenInstances, this._debugDrawShowPointsNames, this._debugDrawShowCustomPoints), e.updatePreRender(this)
            }
        }
        _updateObjectsPreEvents() {
            ...
            for (let n = 0, r = t.length; n < r; ++n) {
                ...
                if (e.hasNoForces()) e.update(this);
                    ...
                    const a = e.getAverageForce(),
                        o = i / 1e3;
                    e.setX(e.getX() + a.getX() * o), e.setY(e.getY() + a.getY() * o), e.update(this), e.updateForces(o)
                }
                e.updateTimers(i), e.stepBehaviorsPreEvents(this)
            }
        ...
        getInitialUnrotatedViewportMaxX() {
            return this._initialInnerArea ? this._initialInnerArea.max[0] : 0
        }
        getInitialUnrotatedViewportMaxY() {
    ...
    s.CustomRuntimeObjectInstanceContainer = l
})(gdjs || (gdjs = {}));
