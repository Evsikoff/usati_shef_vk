...
(function(t) {
    ...
    (function(n) {
        const e = !0
    })(f = t.evtTools || (t.evtTools = {})), t.objectsTypes = new Hashtable, t.behaviorsTypes = new Hashtable, t.callbacksFirstRuntimeSceneLoaded = [], t.callbacksRuntimeSceneLoaded = [], t.callbacksRuntimeScenePreEvents = [], t.callbacksRuntimeScenePostEvents = [], t.callbacksRuntimeScenePaused = [], t.callbacksRuntimeSceneResumed = [], t.callbacksRuntimeSceneUnloading = [], t.callbacksRuntimeSceneUnloaded = [], t.callbacksObjectDeletedFromScene = [], t.gdevelopLogo = "", t.rgbToHex = function(e, n, r) {
    ...
    }, t.shorthandHexToRGBColor = function(e) {
        const n = parseInt(e.replace("#", ""), 16);
        return Number.isFinite(n) ? [17 * (n >> 8 & 15), 17 * (n >> 4 & 15), 17 * (n & 15)] : [0, 0, 0]
    }, t.rgbOrHexToRGBColor = function(e) {
        const n = t.extractRGBString(e);
        if (n) {
            const a = n.split(";");
            if (a.length === 3) return [Math.min(255, parseInt(a[0], 10)), Math.min(255, parseInt(a[1], 10)), Math.min(255, parseInt(a[2], 10))]
        }
        const r = t.extractHexString(e);
        if (r) return t.hexToRGBColor(r);
        const o = t.extractShorthandHexString(e);
        return o ? t.shorthandHexToRGBColor(o) : [0, 0, 0]
        ...
        b: e & 255,
        a: 255
    }), t.hexNumberToRGBArray = e => [e >> 16 & 255, e >> 8 & 255, e & 255], t.extractHexString = e => {
        const n = e.match(l);
        return n ? n[0] : null
    }, t.extractShorthandHexString = e => {
        const n = e.match(s);
        return n ? n[0] : null
    }, t.extractRGBString = e => {
        const n = e.match(b);
        return n ? n[0] : null
    }, t.random = function(e) {
    ...
    t.registerAsynchronouslyLoadingLibraryPromise = e => {
        u.push(e)
    }, t.getAllAsynchronouslyLoadingLibraryPromise = () => Promise.all(u)
