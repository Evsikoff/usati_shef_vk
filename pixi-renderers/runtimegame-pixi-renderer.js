...
(function(l) {
    ...
    class R {
        constructor(e, t) {
            ...
            this._game = e, this._forceFullscreen = t, this._marginLeft = this._marginTop = this._marginRight = this._marginBottom = 0, this._setupOrientation()
        }
        createStandardCanvas(e) {
            this._throwIfDisposed();
            const t = document.createElement("canvas");
            e.appendChild(t), this.initializeRenderers(t), this.initializeCanvas(t)
        }
        initializeRenderers(e) {
            this._throwIfDisposed(), typeof THREE != "undefined" ? (this._threeRenderer = new THREE.WebGLRenderer({
                canvas: e,
                antialias: this._game.getAntialiasingMode() !== "none" && (this._game.isAntialisingEnabledOnMobile() || !l.evtTools.common.isMobile()),
                preserveDrawingBuffer: !0
            }), this._threeRenderer.useLegacyLights = !0, this._threeRenderer.autoClear = !1, this._threeRenderer.setSize(this._game.getGameResolutionWidth(), this._game.getGameResolutionHeight()), this._pixiRenderer = new PIXI.Renderer({
                ...
                preserveDrawingBuffer: !0,
                antialias: !1
            }), this._pixiRenderer.plugins.accessibility.destroy(), delete this._pixiRenderer.plugins.accessibility
        }
        initializeCanvas(e) {
            this._gameCanvas = e, e.style.position = "absolute", e.tabIndex = 1, e.style.userSelect = "none", e.style.outline = "none";
            const t = document.createElement("div");
            t.style.position = "absolute", t.style.overflow = "hidden", t.style.outline = "none", t.style.pointerEvents = "none", t.addEventListener("scroll", i => {
        ...
        _resizeCanvas() {
            ...
            let t = this._game.getGameResolutionWidth(),
                ...
                a = window.innerHeight - this._marginTop - this._marginBottom;
            if (o < 0 && (o = 0), a < 0 && (a = 0), e && !this._keepRatio) t = o, i = a;
            else if (e && this._keepRatio || t > o || i > a) {
                let d = o / t;
                i * d > a && (d = a / i), t *= d, i *= d
            }
        ...
        setMargins(e, t, i, o) {
            this._throwIfDisposed(), !(this._marginTop === e && this._marginRight === t && this._marginBottom === i && this._marginLeft === o) && (this._marginTop = e, this._marginRight = t, this._marginBottom = i, this._marginLeft = o, this._resizeCanvas())
        }
        setWindowSize(e, t) {
            this._throwIfDisposed();
            ...
            if (i) {
                ...
                try {
                    ...
                    u.error(`Window size setting to width ${e} and height ${t} failed. See error:`, a)
                }
            } else u.warn("Window size can't be changed on this platform.")
        }
        centerWindow() {
            this._throwIfDisposed();
            ...
            if (e) {
                ...
                try {
                    ...
                    u.error("Window centering failed. See error:", i)
                }
            } else u.warn("Window can't be centered on this platform.")
        }
        setFullScreen(e) {
            if (this._throwIfDisposed(), !this._forceFullscreen && this._isFullscreen !== e) {
                ...
                if (t) {
                    ...
                    try {
                        ...
                        u.error(`Full screen setting to ${this._isFullscreen} failed. See error:`, o)
                    }
                } else this._isFullscreen ? document.documentElement.requestFullscreen ? document.documentElement.requestFullscreen() : document.documentElement.mozRequestFullScreen ? document.documentElement.mozRequestFullScreen() : document.documentElement.webkitRequestFullScreen && document.documentElement.webkitRequestFullScreen() : document.exitFullscreen ? document.exitFullscreen() : document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.webkitCancelFullScreen && document.webkitCancelFullScreen();
                this._resizeCanvas()
            }
        }
        isFullScreen() {
            ...
            if (e) try {
                ...
                return u.error("Full screen detection failed. See error:", t), !1
            }
            return this._isFullscreen || window.screen.height === window.innerHeight
        }
        convertCanvasToDomElementContainerCoords(e, t) {
            const i = t || [0, 0];
            return i[0] = e[0] * this._canvasWidth / this._game.getGameResolutionWidth(), i[1] = e[1] * this._canvasHeight / this._game.getGameResolutionHeight(), i
        }
        getCanvasToDomElementContainerHeightScale() {
            return (this._canvasHeight || 1) / this._game.getGameResolutionHeight()
        }
        convertPageToGameCoords(e, t) {
            const i = this._gameCanvas;
            if (!i) return [0, 0];
            const o = [e - i.offsetLeft, t - i.offsetTop];
            return o[0] *= this._game.getGameResolutionWidth() / (this._canvasWidth || 1), o[1] *= this._game.getGameResolutionHeight() / (this._canvasHeight || 1), o
        }
        bindStandardEvents(e, t, i) {
            ...
            if (!o) return;
            const a = n => {
                const s = n.pageX - o.offsetLeft,
                    r = n.pageY - o.offsetTop;
                return 0 <= s && s < (this._canvasWidth || 1) && 0 <= r && r < (this._canvasHeight || 1)
            };
            (function() {
                isNaN(o.offsetLeft) && (o.offsetLeft = 0, o.offsetTop = 0), isNaN(i.body.scrollLeft) && (i.body.scrollLeft = 0, i.body.scrollTop = 0), (i.documentElement === void 0 || i.documentElement === null) && (i.documentElement = {}), isNaN(i.documentElement.scrollLeft) && (i.documentElement.scrollLeft = 0, i.documentElement.scrollTop = 0), isNaN(o.offsetLeft) && (o.offsetLeft = 0, o.offsetTop = 0)
            })();
            const d = () => !(i.activeElement === o || i.activeElement === i.body || i.activeElement === null),
                c = n => !(n.target === o || n.target === i.body);
            i.onkeydown = function(n) {
                d() || (m.includes(n.keyCode) && n.preventDefault(), e.onKeyPressed(n.keyCode, n.location))
            }, i.onkeyup = function(n) {
                d() || (m.includes(n.keyCode) && n.preventDefault(), e.onKeyReleased(n.keyCode, n.location))
            };
            ...
            o.onmousemove = n => {
                const s = this.convertPageToGameCoords(n.pageX, n.pageY);
                e.onMouseMove(s[0], s[1])
            }, o.onmousedown = n => {
                const s = this.convertPageToGameCoords(n.pageX, n.pageY);
                return e.onMouseMove(s[0], s[1]), e.onMouseButtonPressed(g(n.button)), t.focus !== void 0 && t.focus(), !1
            }, o.onmouseup = function(n) {
                return e.onMouseButtonReleased(g(n.button)), !1
            }, o.onmouseleave = function(n) {
                e.onMouseLeave()
                ...
                for (let r = 0, h = s.length; r < h; ++r) {
                    const f = s[r],
                        p = (n.buttons & 1 << r) != 0,
                        _ = e.isMouseButtonPressed(f);
                    p && !_ ? e.onMouseButtonPressed(f) : !p && _ && e.onMouseButtonReleased(f)
                }
            }, t.addEventListener("click", function(n) {
                return t.focus !== void 0 && t.focus(), !1
            }, !1), o.oncontextmenu = function(n) {
                return n.preventDefault(), n.stopPropagation(), !1
            }, o.onwheel = function(n) {
                e.onMouseWheel(-n.deltaY)
            }, t.addEventListener("touchmove", n => {
                if (!c(n) && (n.preventDefault(), n.changedTouches))
                    for (let s = 0; s < n.changedTouches.length; ++s) {
                        const r = n.changedTouches[s],
                            h = this.convertPageToGameCoords(r.pageX, r.pageY);
                        e.onTouchMove(r.identifier, h[0], h[1]), e.isSimulatingMouseWithTouch() && (a(r) ? e.onMouseEnter() : e.onMouseLeave())
                    }
            }, {
                passive: !1
                ...
                if (!c(n)) {
                    if (n.preventDefault(), n.changedTouches)
                        for (let s = 0; s < n.changedTouches.length; ++s) {
                            const r = n.changedTouches[s],
                                h = this.convertPageToGameCoords(r.pageX, r.pageY);
                            e.onTouchStart(n.changedTouches[s].identifier, h[0], h[1])
                        }
                    return !1
                }
            }, {
                ...
                if (!c(n)) {
                    if (n.preventDefault(), n.changedTouches)
                        for (let s = 0; s < n.changedTouches.length; ++s) e.onTouchEnd(n.changedTouches[s].identifier);
                    return !1
                }
            }, {
                passive: !1
            }), t.addEventListener("touchcancel", function(n) {
                if (!c(n)) {
                    if (n.preventDefault(), n.changedTouches)
                        for (let s = 0; s < n.changedTouches.length; ++s) e.onTouchCancel(n.changedTouches[s].identifier);
                    return !1
                }
            }, {
                passive: !1
        ...
        startGameLoop(e) {
            ...
            const i = o => {
                ...
                const a = t ? o - t : 0;
                t = o, e(a) || cancelAnimationFrame(this._nextFrameId)
            };
        ...
        openURL(e) {
            if (typeof window != "undefined") {
                ...
                t ? t.shell.openExternal(e) : typeof window.cordova != "undefined" && typeof window.cordova.InAppBrowser != "undefined" ? window.cordova.InAppBrowser.open(e, "_system", "location=yes") : window.open(e, "_blank")
            }
        }
        stopGame() {
            const e = this.getElectronRemote();
            if (e) {
                ...
                if (t) try {
                    ...
                    u.error("Window closing failed. See error:", i)
                }
        ...
        _throwIfDisposed() {
            if (this._wasDisposed) throw "The RuntimeGameRenderer has been disposed and should not be used anymore."
        }
    }
    l.RuntimeGamePixiRenderer = R, l.RuntimeGameRenderer = R
})(gdjs || (gdjs = {}));
