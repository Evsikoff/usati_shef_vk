...
(function(l) {
    const n = new l.Logger("PIXI Image manager"),
        T = (u, e) => {
            n.error("Unable to load file " + u + " with error:", e || "(unknown error)")
        },
        d = (u, e) => {
            !u || e.smoothed || (u.baseTexture.scaleMode = PIXI.SCALE_MODES.NEAREST)
        },
        A = (u, e) => {
            e && !e.smoothed && (u.magFilter = THREE.NearestFilter, u.minFilter = THREE.NearestFilter)
        },
        g = ["image", "video"];
    class x {
        constructor(e) {
            ...
            this._resourceLoader = e, this._invalidTexture = PIXI.Texture.from("data:image/png;base64,", {
                width: 192,
                height: 192
            }), this._loadedThreeTextures = new Hashtable, this._loadedThreeMaterials = new Hashtable
        }
        getResourceKinds() {
            return g
        }
        getPIXITexture(e) {
            ...
            const t = this._loadedTextures.get(r);
            return t ? t.valid ? t : (n.error("Texture for " + e + " is not valid anymore (or never was)."), this._invalidTexture) : this._invalidTexture
        }
        getOrLoadPIXITexture(e) {
            const r = this._getImageResource(e);
            if (!r) return n.warn('Unable to find texture for resource "' + e + '".'), this._invalidTexture;
            const t = this._loadedTextures.get(r);
            if (t) return t.valid ? t : (n.error("Texture for " + e + " is not valid anymore (or never was)."), this._invalidTexture);
            n.log('Loading texture for resource "' + e + '"...');
            const i = r.file,
                o = this._resourceLoader.getFullUrl(i),
                s = PIXI.Texture.from(o, {
                    resourceOptions: {
                        crossorigin: this._resourceLoader.checkIfCredentialsRequired(i) ? "use-credentials" : "anonymous"
                    }
                }).on("error", a => {
                    T(i, a)
                });
            if (!s) throw new Error("Texture loading by PIXI returned nothing for file " + i + " behind url " + o);
            return d(s, r), this._loadedTextures.set(r, s), s
        }
        getThreeTexture(e) {
            const r = this._loadedThreeTextures.get(e);
            if (r) return r;
            const t = this.getPIXITexture(e);
            if (!this._resourceLoader._runtimeGame.getRenderer().getPIXIRenderer()) throw new Error("No PIXI renderer was found.");
            const o = t.baseTexture.resource.source;
            if (!(o instanceof HTMLImageElement)) throw new Error(`Can't load texture for resource "${e}" as it's not an image.`);
            const s = new THREE.Texture(o);
            s.magFilter = THREE.LinearFilter, s.minFilter = THREE.LinearFilter, s.wrapS = THREE.RepeatWrapping, s.wrapT = THREE.RepeatWrapping, s.colorSpace = THREE.SRGBColorSpace, s.needsUpdate = !0;
            const a = this._getImageResource(e);
            return A(s, a), this._loadedThreeTextures.put(e, s), s
        }
        getThreeMaterial(e, {
            useTransparentTexture: r,
            forceBasicMaterial: t,
            vertexColors: i
        }) {
            const o = `${e}|${r?1:0}|${t?1:0}|${i?1:0}`,
                s = this._loadedThreeMaterials.get(o);
            if (s) return s;
            const a = t ? new THREE.MeshBasicMaterial({
            ...
            return this._loadedThreeMaterials.put(o, a), a
        }
        ...
        async _loadTexture(e) {
            if (!this._loadedTextures.get(e)) try {
                if (e.kind === "video") await new Promise((r, t) => {
                    const i = PIXI.Texture.from(this._resourceLoader.getFullUrl(e.file), {
                        resourceOptions: {
                    ...
                    i.baseTexture.on("loaded", () => {
                        this._loadedTextures.set(e, i), d(i, e), r()
                    }).on("error", s => {
                        t(s)
                    })
                });
        ...
        getOrCreateDiskTexture(e, r) {
            let t = this._diskTextures.get(e);
            if (!t) {
                const i = new PIXI.Graphics;
                i.lineStyle(0, 0, 0), i.beginFill(l.rgbToHexNumber(255, 255, 255), 1), i.drawCircle(0, 0, e), i.endFill(), t = r.generateTexture(i), i.destroy(), this._diskTextures.set(e, t)
            }
            return t
        }
        getOrCreateRectangleTexture(e, r, t) {
            const i = `${e}_${r}`;
            let o = this._rectangleTextures.get(i);
            if (!o) {
                const s = new PIXI.Graphics;
                s.lineStyle(0, 0, 0), s.beginFill(l.rgbToHexNumber(255, 255, 255), 1), s.drawRect(0, 0, e, r), s.endFill(), o = t.generateTexture(s), s.destroy(), this._rectangleTextures.set(i, o)
            }
            return o
        }
        getOrCreateScaledTexture(e, r, t, i) {
            const o = `${e}_${r}_${t}`;
            let s = this._scaledTextures.get(o);
            if (!s) {
                const a = new PIXI.Graphics,
                    c = new PIXI.Sprite(this.getPIXITexture(e));
                c.width = r, c.height = t, a.addChild(c), s = i.generateTexture(a), a.destroy(), this._scaledTextures.set(o, s)
            }
            return s
        }
        dispose() {
            ...
            const e = [];
            this._loadedThreeTextures.values(e), this._loadedThreeTextures.clear();
            for (const t of e) t.dispose();
            const r = [];
            this._loadedThreeMaterials.values(r), this._loadedThreeMaterials.clear();
            for (const t of r) t.dispose();
            for (const t of this._diskTextures.values()) t.destroyed || t.destroy();
            this._diskTextures.clear();
            for (const t of this._rectangleTextures.values()) t.destroyed || t.destroy();
            this._rectangleTextures.clear();
            for (const t of this._scaledTextures.values()) t.destroyed || t.destroy();
            this._scaledTextures.clear()
        }
    }
    l.PixiImageManager = x, l.ImageManager = l.PixiImageManager
})(gdjs || (gdjs = {}));
