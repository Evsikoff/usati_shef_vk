...
(function(i) {
    const o = class {
        ...
        hasTouchEnded(e) {
            return this._mouseOrTouches.containsKey(e) ? this._mouseOrTouches.get(e).justEnded : !1
        }
        ...
        _moveTouch(e, s, t) {
            const u = this._mouseOrTouches.get(e);
            !u || (u.x = s, u.y = t)
        }
        onTouchEnd(e) {
    ...
    let r = o;
    r.MOUSE_LEFT_BUTTON = 0, r.MOUSE_RIGHT_BUTTON = 1, r.MOUSE_MIDDLE_BUTTON = 2, r.MOUSE_BACK_BUTTON = 3, r.MOUSE_FORWARD_BUTTON = 4, r.MOUSE_TOUCH_ID = 1, r._DEFAULT_LEFT_VARIANT_KEYS = [16, 17, 18, 91], r._allTouchIds = [], i.InputManager = r
})(gdjs || (gdjs = {}));
