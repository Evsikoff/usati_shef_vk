...
(function(i) {
    class l {
        ...
        processTasks(e) {
            for (let s = 0; s < this.tasksWithCallback.length; s++) {
                ...
                r.asyncTask.update(e) && (r.callback(e), this.tasksWithCallback.splice(s--, 1))
            }
        }
        addTask(e, s) {
    ...
    class o extends t {
        ...
        update(e) {
            for (let s = 0; s < this.tasks.length; s++) this.tasks[s].update(e) && this.tasks.splice(s--, 1);
