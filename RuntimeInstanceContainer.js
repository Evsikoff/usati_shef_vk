...
(function(l) {
    ...
    class u {
        ...
        createObjectsFrom(e, t, s, a, n) {
            let i, r;
            arguments.length === 5 ? (i = a, r = n) : (i = 0, r = arguments[3]);
            for (let h = 0, g = e.length; h < g; ++h) {
                const o = e[h],
                    _ = o.name,
                    c = this.createObject(_);
                c !== null && (r && (c.persistentUuid = o.persistentUuid || null), c.setPosition(o.x + t, o.y + s), c.setAngle(o.angle), l.Base3DHandler && l.Base3DHandler.is3D(c) && (c.setZ((o.z || 0) + i), o.rotationX !== void 0 && c.setRotationX(o.rotationX), o.rotationY !== void 0 && c.setRotationY(o.rotationY)), c.setZOrder(o.zOrder), c.setLayer(o.layer), c.getVariables().initFrom(o.initialVariables, !0), c.extraInitializationFromInitialInstance(o))
            }
        }
            ...
            for (let t = 0, s = e.length; t < s; ++t) {
                ...
                if (a.hasNoForces()) a.update(this);
                    ...
                    const i = a.getAverageForce(),
                        r = n / 1e3;
                    a.setX(a.getX() + i.getX() * r), a.setY(a.getY() + i.getY() * r), a.update(this), a.updateForces(r)
                }
                    ...
                    for (let s = 0, a = t.length; s < a; ++s) {
                        ...
                        if (!n.hasNoForces()) {
                            const i = n.getAverageForce(),
                                r = n.getElapsedTime() / 1e3;
                            n.setX(n.getX() + i.getX() * r), n.setY(n.getY() + i.getY() * r), n.updateForces(r)
                        }
                    }
                }
        }
